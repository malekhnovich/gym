...
Insert into Excercise values(1, 'bicep curl', 'hold dumbbell in hand and curl it focusing on the bicep muscle');
Insert into Excercise values(2, 'Dips', 'rise up over the bars and bend elbow until level with bar, focus on triceps');
Insert into Excercise values(3,'chest bench press','hold bar up and lower until bar hits chest and then rise back up');
...
Insert into ExternalInstructorInstructor values(3,'Cory Smith',60);
